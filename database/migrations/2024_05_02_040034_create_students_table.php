...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('students', function (Blueprint $table) {
            ...
            $table->string('jalur_pendaftaran_id')->comment('Jalur pendaftaran (Umum/Prestasi)');
            ...
            $table->bigInteger('jurusan')->comment('Jurusan Siswa');
            $table->enum('registrasi_ulang', ['true', 'false'])->comment('Konfirmasi pendaftaran ulang');
            $table->bigInteger('no_ijazah')->comment('Nomor Ijazah sebelumnya');
            ...
            $table->integer('nik')->limit(16)->unique()->comment('Nomor Induk Kependudukan');
            $table->integer('nis')->limit(10)->nullable()->comment('Nomor Induk Siswa');
            $table->integer('nisn')->limit(10)->nullable()->comment('Nomor Induk Siswa Nasional');
            ...
            $table->integer('no_hp')->limit(16)->comment('Nomor HP/WA siswa');
            $table->string('email')->nullable()->comment('Email pribadi siswa');
            $table->integer('sktm')->limit(50)->nullable()->comment('Nomor Surat Keterangan Tidak Mampu');
            $table->integer('kip')->limit(50)->nullable()->comment('Nomor Kartu Indonesia Pintar');
